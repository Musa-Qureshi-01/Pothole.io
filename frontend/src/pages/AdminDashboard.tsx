                ...
                <div className="border-t border-slate-100 dark:border-slate-800 pt-4 space-y-3">
                  ...
                  {selectedReport.status !== 'fixed' && selectedReport.status !== 'assigned' && (
                    <div className="space-y-2 mb-4">
                      <label className="text-xs font-semibold text-slate-500">Assign to Worker</label>
                      <div className="flex gap-2">
                        <select
                          className="flex-1 h-9 rounded-md border border-slate-200 bg-white px-3 py-1 text-sm shadow-sm transition-colors dark:border-slate-800 dark:bg-slate-950"
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {/* Show mark fixed only if not already fixed */}
